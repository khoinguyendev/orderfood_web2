...
const SlideBar = () => {
  return (
    <aside id="sidebar" className="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width hidden" aria-label="Sidebar">
      <div className="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
          <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
            <ul className="pb-2 space-y-2">
              ...
              <li>
                <Link to="/admin" className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                  <svg
              ...
              <Dropdown
                item={{
                  ...
                  children: [
                    ...
                    { name: "Order", link: "crud/list/orders" },
                    { name: "Image", link: "crud/list/images" },
                    { name: "Review", link: "crud/list/reviews" },
                  ],
                }}
              />
        ...
        <div className="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800">
          <Link to="/admin/auth/password" className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
          ...
          <div
            ...
            style={{ position: "absolute", inset: "auto auto 0px 0px", margin: 0, transform: "translate(71px, -64px)" }}
            data-popper-placement="top"
          >
            Settings page
            <div className="tooltip-arrow" data-popper-arrow style={{ position: "absolute", left: 0, transform: "translate(54px, 0px)" }} />
          </div>
          <button
            type="button"
          ...
          <div
            className="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 hidden"
            id="language-dropdown"
            style={{ position: "absolute", inset: "0px auto auto 0px", margin: 0, transform: "translate(184px, 705px)" }}
            aria-hidden="true"
