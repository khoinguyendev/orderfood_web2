...
const ItemUser = ({ user, stt,setLoad }: ItemUser) => {
  ...
  return (
    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <td className="text-base font-semibold text-gray-900 dark:text-white">{user.name}</td>
     
      <td className="text-base font-semibold text-gray-900 dark:text-white">{user.email}</td>
      <td className="text-base font-semibold text-gray-900 dark:text-white">{user.address}</td>
      <td className="text-base font-semibold text-gray-900 dark:text-white">{user.role}</td>

      <td className="p-4 space-x-2 whitespace-nowrap">
        <Link
          to={`/admin/crud/edit/category/${user.id}`}
