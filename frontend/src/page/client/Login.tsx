          ...
          <div className="col-span-8 grid grid-cols-12">
            <div className="col-span-7 p-6 border border-primary text-gray1">
              ...
              <div className="mt-5 flex">
                <button className="flex-1 bg-primary text-white py-2 px-4 rounded font-bold">Đăng nhập</button>
              </div>
            </div>
            <div className="col-span-5 bg-primary text-white p-6">
              ...
              <div className="mt-5 text-center">
                <Link to={"/dang-ky"} className="border border-white rounded py-2 px-8">
                  Đăng ký
                </Link>
              </div>
            </div>
